...
if __name__ == '__main__':
    ...
    test_cmd = "tests_building.py::test_shell_building".format("test_shell_building")
    pytest.main(["-s", test_cmd, '--html={}.html'.format(time.strftime('%Y%m%d_%H%M%S', time.localtime())),
